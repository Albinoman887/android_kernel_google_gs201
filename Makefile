...
KBUILD_USERHOSTCFLAGS := -Wno-all -Wmissing-prototypes -Wstrict-prototypes \
			 -O2 -fomit-frame-pointer -std=gnu89 -Wno-unused-command-line-argument
...
KBUILD_CFLAGS   := -Wno-all -Wundef -Werror=strict-prototypes -Wno-trigraphs \
		   -fno-strict-aliasing -fno-common -fshort-wchar -fno-PIE \
		   -Werror=implicit-function-declaration -Werror=implicit-int \
		   -Werror=return-type -Wno-format-security \
		   -std=gnu89 -Wno-unused-command-line-argument
